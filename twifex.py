...
class timeDependentLocationDependentTweetMassFeatures(temporalFeatures, placeFeatures):
    ...
    def temporal_spatial_tweet_likes_count(self, order='spatial-temporal', temporal_resolution='day', temporal_frequency=1, spatial_resolution='country'):
        """
        :param order: the hierarchical structure of temporal-spatial embedded dictionary. If it is "spatial-temporal", then the first key would be a location and the second one is a timestamp. Otherwise and if the valuse of this parameter is equal to "temporal-spatial", then the first key would be a timestamp and the second one is a location.
        :param temporal_resolution: the time resolution of tweets categories. It can be "year", "month", "week", "day",
        "hour", "minute" and "second".
    ...
    def temporal_spatial_tweet_retweet_count(self, order='spatial-temporal', temporal_resolution='day', temporal_frequency=1, spatial_resolution='country'):
        """
        :param order: the hierarchical structure of temporal-spatial embedded dictionary. If it is "spatial-temporal", then the first key would be a location and the second one is a timestamp. Otherwise and if the valuse of this parameter is equal to "temporal-spatial", then the first key would be a timestamp and the second one is a location.
        :param temporal_resolution: the time resolution of tweets categories. It can be "year", "month", "week", "day",
        "hour", "minute" and "second".
    ...
    def temporal_spatial_tweet_language(self, order='spatial-temporal', temporal_resolution='day', temporal_frequency=1, spatial_resolution='country'):
        """
        :param order: the hierarchical structure of temporal-spatial embedded dictionary. If it is "spatial-temporal", then the first key would be a location and the second one is a timestamp. Otherwise and if the valuse of this parameter is equal to "temporal-spatial", then the first key would be a timestamp and the second one is a location.
        :param temporal_resolution: the time resolution of tweets categories. It can be "year", "month", "week", "day",
        "hour", "minute" and "second".
    ...
    def temporal_spatial_tweet_emojis(self, order='spatial-temporal', temporal_resolution='day', temporal_frequency=1, spatial_resolution='country'):
        """
        :param order: the hierarchical structure of temporal-spatial embedded dictionary. If it is "spatial-temporal", then the first key would be a location and the second one is a timestamp. Otherwise and if the valuse of this parameter is equal to "temporal-spatial", then the first key would be a timestamp and the second one is a location.
        :param temporal_resolution: the time resolution of tweets categories. It can be "year", "month", "week", "day",
        "hour", "minute" and "second".
    ...
    def temporal_spatial_tweet_case_analysis(self, order='spatial-temporal', temporal_resolution='day', temporal_frequency=1,
                                      spatial_resolution='country', unit_of_analysis='character'):
