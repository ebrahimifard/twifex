...
#
#
# q.tweet_level_retweet_quote_reply_network_building()
# q.user_followers_count_layer(network_type="tweet_level_retweet_quote_reply_network")
# print("57")
# q.user_friends_count_layer(network_type="tweet_level_retweet_quote_reply_network")
# print("58")
# q.user_role_count_layer(network_type="tweet_level_retweet_quote_reply_network")
# print("59")
# q.users_with_verification_layer(network_type="tweet_level_retweet_quote_reply_network")
# print("60")
# q.users_status_count_layer(network_type="tweet_level_retweet_quote_reply_network")
# print("61")
# q.users_total_likes_count_layer(network_type="tweet_level_retweet_quote_reply_network")
# print("62")

r = twifex.collective_tweets(_tweets).topology_based_features().time_dependent_features().time_dependent_location_independent_network_features().tweet_features()
print("63")
r.network_building_in_each_timeframe()
r.tweet_complexity_layer_in_different_timeframes()
print("64")
