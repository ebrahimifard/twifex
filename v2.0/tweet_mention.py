...
class TweetMention(TweetEntities):
    ...
    def get_tweet_mentions(self, return_format="screen_name", at_symbol=True, distinct_mentions=True):
        """
    ...
    def mention_replacement(self, input_text=None, inplace=False):
        ...
        :param input_text: if this parameter is None, then the mention replacement is applied on the caller object,
        otherwise and in case of a string as an input for this parameter, the mention replacement is applied to the input text.
